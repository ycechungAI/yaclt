...
<img src="https://github.com/mrjones2014/yaclt/raw/master/images/logo_color_on_transparent.png" alt="yaclt logo" height="135" style="margin-top: -5%;" align="right"/>
...
then use `yaclt` again to gather each individual entry into `CHANGELOG.md` as part of your release process. Customize your entry and `CHANGELOG.md` format using [Handlebars](https://handlebarsjs.com).
